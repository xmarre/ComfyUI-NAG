...
def set_nag_wan(
    ...
    model.forward_orig = MethodType(NAGWanModel.forward_orig, model)
...
def set_origin_wan(model: NAGWanModel):
    model.forward_orig = MethodType(WanModel.forward_orig, model)
    model.forward = MethodType(WanModel.forward, model)
